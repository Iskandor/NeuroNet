...
QNatLearning::QNatLearning(NeuralNetwork *p_network, double p_gamma, double p_epsilon, double p_lambda) : StochasticGradientDescent(p_network), LearningAlgorithm() {
    _gamma = p_gamma;
    _epsilon = p_epsilon;
    _lambda = p_lambda;
